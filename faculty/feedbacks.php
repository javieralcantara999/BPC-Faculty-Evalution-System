...
<script>
    document.title = "Student Feedbacks | Faculty Member";
</script>
<h1 class="m-0 text-center"><i class="fas fa-comments"></i>&nbsp;<b> STUDENT FEEDBACKS </b></h1><br>
        ...
        <div class="card-body">
            ...
            <table class="table table-hover table-bordered" style = "background:whitesmoke"id="feedbacksTable">
                ...
                <tbody id="feedbacksBody">
                    <?php
                    $query = "SELECT *,comments FROM evaluation_comments WHERE faculty_id = $faculty_id";
    ...
    $(document).ready(function() {
        ...
        $('#searchComments').on('input', function() {
            ...
            $.ajax({
                url: 'ajax.php',
                type: 'GET',
                data: { action: 'get_sentiment_terms_faculty_students', faculty_id: facultyId },
                dataType: 'json',
