...
<div class="container-fluid">
    <h1 class="m-0 text-left">
        <i class="fas fa-home"></i><b> SUPERIOR EVALUATION DASHBOARD</h1></b><br><hr>
    <div class="row">
        <div class="col-md-4">
                <div class="card">
                    ...
                    <span class="badge badge-primary" style = "font-size: 15px">
                        ...
                        <!-- Add ID to the "Evaluate Now" button for easy identification -->
                        <a id="evaluateButton" class="btn btn-gradient btn-success text-center" 
                        href="./indexx.php?page=evaluate" style="text-decoration: none;" disabled> Evaluate Now </a>

                    <hr></div>
                </div>
            </div>
            <?php 
                            $name = $conn->query("SELECT *,CONCAT(firstname , ' ' , lastname) as name from superior_list
...
<script>
    function updateDateTime() {
        ...
        document.getElementById('currentDateTime').innerHTML = '<b>Date & Time</b><br> ' + formattedDateTime;
