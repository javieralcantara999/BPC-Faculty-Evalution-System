<script>
    document.title = "Evaluation Criteria (Students) | Administrator";
    </script>
<?php include 'db_connect.php'?>

<h1 class="m-0 text-center"><i class="fas fa-clipboard-list"></i>&nbsp;<b>EVALUATION CRITERIA LIST (STUDENTS)</b></h1><br><hr>
                    ...
                    <div class="col-md-8">
                        <div class="callout" style="border: 0px;">
                                    ...
                                    <li class="list-group-item text-left">
                                        <span class="btn-group dropright float-right">
                                          <div class="btn-group" >
                                            ...
                                            class="btn btn-success btn-gradient edit_criteria"
                                            style = "text-decoration: none;color:white;">
                                                <i class="fas fa-cog"></i> Edit
                                            </a>&nbsp;
                                            <button type="button" class="btn btn-danger btn-gradient delete_criteria" 
                                            data-id="<?php echo $row['id'] ?>">
                                                <i class="fas fa-trash-alt"></i> Delete
                                            </button>
                                        </div>
                                        </span>
                                        <i class="fas fa-greater-than justify-content-center"style="margin-right:20px;">&nbsp;</i> <?php echo ucwords($row['criteria']) ?>
                            ...
                            <h6 class = "text-center"><i>Please drag the criteria item to change orders.</i></h6>
                                ...
                                <button class="btn btn-sm btn-success bg-gradient-success mx-4 text-center"
                                 form="order-criteria"style="font-size:18px;">Save List</button>
                        </div>
                    </div>
                    <div class="col-md-4 ">
                    <div class="form-group mb-1 d-flex" >
                            <form method="post" id = "import_criteria_student"enctype="multipart/form-data" class="ml-1">
                            ...
                            <br>
                        <div class="card">
                            <div class="card-header text-center"style = "background:darkgreen;color:white"><b>Criteria Information</b></div>
                            <div class="card-body">
...
<script>
    ...
    $('#import_criteria_student').submit(function(event) {
        event.preventDefault(); // Prevent default form submission
        var formData = new FormData(this);
        start_load()
        $.ajax({
            url: 'ajax.php?action=import_criteria_student',
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
...
$(document).ready(function() {
	...
	$(document).ready(function() {
        ...
        $('#manage-criteria').submit(function(e) {
            ...
            // Retrieve the criteria name input value
            ...
            // Proceed with form submission if the criteria name is not blank
            start_load();
            $('#msg').html('');
