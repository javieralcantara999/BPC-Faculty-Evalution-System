...
<script>
    document.title = "Manage Questions (Students) | Administrator";
</script>
<h1 class="m-0 text-center"><i class="fas fa-envelope-open-text"></i>&nbsp;<b>MANAGE QUESTION FORM (STUDENTS)</b></h1><br><hr>
                    ...
                    ?>
                        <tr class="text-left">
                            ...
                            <td class="text-center">
                                <a href="indexx.php?page=manage_questionnaire&id=<?php echo $row['id'] ?>" class="btn btn-sm btn-success btn-gradient-success manage_questionnaire">
